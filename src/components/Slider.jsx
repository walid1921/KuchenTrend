      ...
      <div className="overflow-hidden" ref={emblaRef}>
        <div className="flex gap-3 md:ml-0 ml-3">
          {steps.map((step) => (
            <div
              key={step.id}
              className=" w-full md:px-[40px] md:mx-[20px] pt-5   pb-6  bg-neutral-300 hover:bg-neutral-200 hover:cursor-pointer  transition-all ease-in-out duration-300"
            >
              <p className="text-primary fill-transparent text-center font-extrabold text-[40px] 2xl:text-[130px] 2xl:mx-12 mx-20">
                {step.number}
              </p>
